        ...
        <c:choose>
            <c:when test="${not empty student}">
                <div class="contact_info mx-auto" style="width: 300px">
                    <form action="${pageContext.request.contextPath}/lec3task1?c=2&id=${student.getStudentId()}"
                    method="post">
                        ...
                        <div class="mb-3 row mx-auto">
                            ...
                            <div class="col-sm">
                                <input type="text" readonly class="form-control"
                                       id="studentCity" name="studentCity" value="${student.getCity()}"
                                       onchange="checkChanges()">
                            </div>
                        </div>
                    ...
                    <form action="${pageContext.request.contextPath}/lec3task1?c=3&id=${student.getStudentId()}"
                          method="post">
...
<script>
    function checkChanges() {
        if (
            ...
            document.getElementById("studentCity").value === '${student.getCity()}'
        ) {
